                  ...
                  <div>
                    ...
                    <div>
                      <span className="font-bold text-xl">
                        {(product.variant_price_from ?? (product.variants?.length === 1 ? product.variants[0]?.price : null)) ? `${product.variants?.length > 1 ? 'Mulai ' : ''}Rp ${Number(product.variant_price_from ?? product.variants[0]?.price).toLocaleString('id-ID')}` : 'Belum tersedia'}
                      </span>
