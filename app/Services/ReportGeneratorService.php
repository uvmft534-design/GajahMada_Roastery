...
class ReportGeneratorService
{
    ...
    private function sales(?string $start, ?string $end): array
    {
        ...
        return ['total_orders' => $totalOrders, 'total_revenue' => $revenue, 'total_items_sold' => (int) $items->sum('qty'), 'average_order_value' => $totalOrders ? (int) round($revenue / $totalOrders) : 0,
